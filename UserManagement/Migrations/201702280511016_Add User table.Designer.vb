...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddUsertable
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddUsertable))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201702280511016_Add User table"
            End Get
        End Property
