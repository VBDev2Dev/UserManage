...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddIsActivepropertytoallowuserlockout
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddIsActivepropertytoallowuserlockout))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201702281505130_Add IsActive property to allow user lockout"
            End Get
        End Property
